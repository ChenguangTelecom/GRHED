...
## 6. Testing with pretrained models on your own image
...
'--test-snapshot' represents the number of training iterations for the pretrained model. It can be 10000, 20000, 30000, etc. 
