...
#from tf.keras.layers.convolutional import Convolution2D, MaxPooling2D, ZeroPadding2D
...
class Vgg16():
    ...
    def define_model(self):
        ...
        self.conv1_1 = tf.layers.conv2d(self.images,64,3,1,padding='SAME',activation=tf.nn.relu) 
        self.conv1_2 = tf.layers.conv2d(self.conv1_1,64,3,1,padding='SAME',activation=tf.nn.relu)
        self.side_1 = self.side_layer(self.conv1_2, "side_1", 1)
        self.pool1 = self.max_pool(self.conv1_2, 'pool1')

        self.io.print_info('Added CONV-BLOCK-1+SIDE-1')

        self.conv2_1 = tf.layers.conv2d(self.pool1,128,3,1,padding='SAME',activation=tf.nn.relu)
        self.conv2_2 = tf.layers.conv2d(self.conv2_1,128,3,1,padding='SAME',activation=tf.nn.relu)
        self.side_2 = self.side_layer(self.conv2_2, "side_2", 2)
        self.pool2 = self.max_pool(self.conv2_2, 'pool2')

        self.io.print_info('Added CONV-BLOCK-2+SIDE-2')
        
        self.conv3_1 = tf.layers.conv2d(self.pool2, 256,3,1,padding='SAME',activation=tf.nn.relu)
        self.conv3_2 = tf.layers.conv2d(self.conv3_1, 256,3,1,padding='SAME',activation=tf.nn.relu)
        self.conv3_3 = tf.layers.conv2d(self.conv3_2, 256,3,1,padding='SAME',activation=tf.nn.relu)
        self.side_3 = self.side_layer(self.conv3_3, "side_3", 4)
        self.pool3 = self.max_pool(self.conv3_3, 'pool3')

        self.io.print_info('Added CONV-BLOCK-3+SIDE-3')
        
        self.conv4_1 = tf.layers.conv2d(self.pool3, 512,3,1,padding='SAME',activation=tf.nn.relu)
        self.conv4_2 = tf.layers.conv2d(self.conv4_1, 512,3,1,padding='SAME',activation=tf.nn.relu)
        self.conv4_3 = tf.layers.conv2d(self.conv4_2, 512,3,1,padding='SAME',activation=tf.nn.relu)
        self.side_4 = self.side_layer(self.conv4_3, "side_4", 8)
        self.pool4 = self.max_pool(self.conv4_3, 'pool4')

        self.io.print_info('Added CONV-BLOCK-4+SIDE-4')
        
        self.conv5_1 = tf.layers.conv2d(self.pool4, 512,3,1,padding='SAME',activation=tf.nn.relu)
        self.conv5_2 = tf.layers.conv2d(self.conv5_1,512,3,1,padding='SAME',activation=tf.nn.relu)
        self.conv5_3 = tf.layers.conv2d(self.conv5_2, 512,3,1,padding='SAME',activation=tf.nn.relu)
